...
{
    std::stringstream sysfsfile_pinA_state;
    std::stringstream sysfsfile_pinB_state;
    std::stringstream sysfsfile_path;

    
    if (_encoder == "eqep0"){
    }
    else if (_encoder == "eqep1"){
    }
    else if (_encoder == "eqep2"){
    }
...
void eQEP::set_position(int position)
{
